...
public class ScanearDocumento extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		// ESTO ES ESCANEO.. ESTA VARIABLE NO LA USAMOS
		detalle_id = "-1";
		// FIN ESTO ES ESCANEO.. ESTA VARIABLE NO LA USAMOS
		
		String solicitudimpresion = "-1";// request.getParameter("solicitudimpresion")
											// != null ? (String) request
		...
		String numCopias = "1";// request.getParameter("numcopias") != null ?
								// (String) request
		...
		String scanner = Utilidades.getScanner() + "|"
		...
		out.println("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.0 "
				...
				+ " </HEAD>\n"
				+ "<BODY>\n"
				+ "<APPLET CODE=appletComponentArch.DynamicScannerApplet.class   archive=\"arch.jar\" WIDTH=300 HEIGHT=300>"
				+ " <PARAM NAME=\"paramInt\" VALUE="
				+ codigoDocumento
				+ ">"
				+ " <PARAM NAME=\"tmp\" VALUE="
				+ tmp
				+ ">"
				+ " <PARAM NAME=\"swBdpostgres\" VALUE="
				+ swBdpostgres
				+ ">"
				+ " <PARAM NAME=\"endPoint\" VALUE="
				+ endPoint
				+ ">"
				+ " <PARAM NAME=\"numCopias\" VALUE="
				+ numCopias
				+ ">"
				+ " <PARAM NAME=\"solicitudimpresion\" VALUE="
				+ solicitudimpresion
				+ ">"
				+ " <PARAM NAME=\"usuarioid\" VALUE="
				+ user_logueado.getId()
				+ ">"
				+ " <PARAM NAME=\"codigoExtra\" VALUE=" + scanner + "> "
				+ " <PARAM NAME=\"tabla\" VALUE=" + "ScannerDoc" + "> "
