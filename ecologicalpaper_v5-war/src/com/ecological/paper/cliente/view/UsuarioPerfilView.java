...
@ManagedBean(name = "usuarioPerfilView")
@SessionScoped
public class UsuarioPerfilView extends ClienteUsuario {
	...
	private boolean swEditarUsuario=true;
	...
	public UsuarioPerfilView() {
		...
		objectItem=user_logueado;
		passwordOculta=objectItem.getPassword();
	}
	...
	public String editar() {
		...
		try {
			...
			if (swEditarUsuario) {
				...
				session.setAttribute("pagIr", "editUsuarioPerfil");
