                ...
                <a4j:region renderRegionOnly="true" id="stat3"> 
                    ...
                    <h:panelGroup id="body">
                        ...
                        <t:dataTable id="data"
                                     ...
                                     var="car"
                                     value="#{DiasHabilesByHoras.listaDiasHabiles}"
                        ...
                        >
                            <h:column>
                                ...
                                <h:panelGroup rendered="#{DiasHabilesByHoras.swMod}">
                                    
                                    
                                    <h:commandLink id="detalle"     
                                                   action="#{DiasHabilesByHoras.editar}" 
                                                   actionListener="#{DiasHabilesByHoras.versionId}"
                                    >
                                        <h:outputText styleClass="node" value="#{car.nombreStr}"
                                                       title="#{car.nombreStr}"/>
                                        
                                        <f:param id="editId2_Detalle" 
                                                 name="idDetalle" 
                                                 value="#{car.codigo}" />
                                    </h:commandLink>
                            ...
                            <h:column>
                                <f:facet name="header">
                                    <h:outputText   styleClass="grees" value="#{txt.HoraInicialAm}" />
                                </f:facet>
                                <h:outputText  styleClass="node" value="#{car.h_InicialAM}" />
                            </h:column>
                            
                            <h:column>
                                <f:facet name="header">
                                    <h:outputText   styleClass="grees" value="#{txt.HoraFinalAm}" />
                                </f:facet>
                                <h:outputText  styleClass="node" value="#{car.h_FinalAM}" />
                            </h:column>
                            
                            
                            <h:column>
                                <f:facet name="header">
                                    <h:outputText   styleClass="grees" value="#{txt.HoraInicialPm}" />
                                </f:facet>
                                <h:outputText  styleClass="node" value="#{car.h_InicialPM}" />
                            </h:column>
                            
                            <h:column>
                                <f:facet name="header">
                                    <h:outputText   styleClass="grees" value="#{txt.HoraFinalPm}" />
                                </f:facet>
                                <h:outputText  styleClass="node" value="#{car.h_FinalPM}" />
                            </h:column>
