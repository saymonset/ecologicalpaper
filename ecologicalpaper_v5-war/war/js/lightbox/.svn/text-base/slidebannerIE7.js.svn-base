...
imageArray[imageNum++] = new imageItem(imageDir + "980x272-full-descargas-ipad2.jpg",'http://www.movistar.com.ve/particulares/contenidos/promociones_gana_ipad.asp');
imageArray[imageNum++] = new imageItem(imageDir + "980x272-recargas-movistar-vale_la_pena_tener_30.jpg",'http://www.movistar.com.ve/particulares/movil/promo_recarga_vale_la_pena_tener_30.asp');
imageArray[imageNum++] = new imageItem(imageDir + "974x272-promo-enamorados-2012.jpg",'http://movistar.com.ve/particulares/movil/promo_enamorados_2012.asp');
imageArray[imageNum++] = new imageItem(imageDir + "974x272-recargas-movistar-roques.jpg",'http://movistar.com.ve/particulares/movil/promociones_enamorados_roques_2012.asp');
imageArray[imageNum++] = new imageItem(imageDir + "974x272-promo-enamorados-2012-fijo.jpg",'http://movistar.com.ve/particulares/fijo/promo_enamorados_2012.asp');
imageArray[imageNum++] = new imageItem(imageDir + "980x272_movicupones_7.jpg",'http://movistar.com.ve/particulares/oferta-del-dia/ofertadeldia.asp');
imageArray[imageNum++] = new imageItem(imageDir + "980x272-club-movistar-quick-press.jpg",'http://movistar.com.ve/particulares/club_movistar/promo_quick_press.asp');
imageArray[imageNum++] = new imageItem(imageDir + "974x272_movil_android.jpg",'http://www.movistar.com.ve/particulares/movil/android.asp');
...
//		alert('');
		...
		cajaboton.id = 'columna_'+x;
		cajaboton.setAttribute("class","columna");
		cajaboton.style.position = '';
		cajaboton.style.width = '13px';
		cajaboton.style.height = '13px';
		//cajaboton.style.float = 'left';
		cajaboton.style.clear = 'both';
		//cajaboton.style.display = 'block';
		cajaboton.style.backgroundColor = "black";
		...
		linkboton.style.width = '13px';
		linkboton.style.height = '13px';
		//linkboton.style.float = 'left';
		linkboton.style.clear = 'both';
		linkboton.style.marginRight = '1px';
		//linkboton.style.display = 'block';
		//linkboton.style.backgroundColor = "aqua";
...
//		alert(linkboton);
		...
		imagen.style.height = '13px';
		//imagen.style.float = 'left';
		imagen.style.clear = 'both';
...
//		alert(imagen.src);
		...
		controles.appendChild(linkboton);
