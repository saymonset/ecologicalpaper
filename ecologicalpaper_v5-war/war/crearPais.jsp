...
<f:view>
	...
	<h:form>
		<h:panelGrid columns="3" id="panelGrid1">
			...
			<h:inputText id="nombre" value="#{CrearPais.pais.nombre}"
			...
			<h:inputText required="false" id="descripcion"
				value="#{CrearPais.pais.descripcion}"
			...
			<h:commandButton styleClass="boton" id="btncancel" value="#{txt.btn_cancelar}"
				action="#{CrearPais.cancelarListar}" />

			<h:commandButton styleClass="boton" action="#{CrearPais.create}"
