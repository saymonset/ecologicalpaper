			...
			<a4j:region renderRegionOnly="true" id="stat3">
				...
				<t:dataTable id="data" rowIndexVar="rowIndexVar"
					...
					<h:column>
						...
						<h:panelGroup rendered="#{ConfiguracionCliente.swMod}">
							<h:commandLink id="Edit" action="#{ConfiguracionCliente.edit}"
								actionListener="#{ConfiguracionCliente.selection}">
								<h:outputText styleClass="node" value="#{car.smtpHost}" />
								<f:param id="editId" name="id" value="#{car.codigo}" />
							</h:commandLink>
						</h:panelGroup>
						<h:panelGroup rendered="#{!ConfiguracionCliente.swMod}">
							<h:outputText styleClass="node" value="#{car.smtpHost}" title="#{car.smtpHost}" />
						</h:panelGroup>
					</h:column>
					...
					<h:column>
						...
						<h:outputText styleClass="grees" value="#{car.carpetaCompartida}" />
					</h:column>
