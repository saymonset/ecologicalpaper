    ...
    <body>
		...
		<t:jscookMenu   layout="hbr" theme="ThemeOffice"
            ...
            <h:form>
                ...
                <h1><h:outputText styleClass="node"   value="#{txt.doc_listar_edos}"/></h1>
                <a4j:region renderRegionOnly="true" id="stat3"> 
                    <h1> <h:outputText styleClass="node" value="#{txt.search_buscar}" />
                    </h1>
                    <f:verbatim>&nbsp;</f:verbatim>
                    <h:inputText  id="searchtext" value="#{Doc_edo.strBuscar}" immediate="true">
                        <a4j:support  event="onkeyup" reRender="repeater,data" />
                    </h:inputText>
                    <h:outputText   styleClass="node" id="repeater" value="#{Doc_edo.strBuscar}" />
                    ...
                    <h:panelGroup id="body">
                        ...
                        >
                            <h:column>
                                ...
                                <h:commandLink  id="Edit" 
                                                action="#{Doc_edo.edit}" 
                                                actionListener="#{Doc_edo.selectId}">
                        ...
                        <h:panelGrid columns="3" binding="#{backing_login.panelGrid1}"
                            ...
                            <h:commandButton styleClass="boton"  value="#{txt.btn_cancelar}" 
                                             action="#{Doc_edo.cancelarLista}"/>
                            
                            <h:commandButton styleClass="boton"  value="#{txt.btn_crear}" 
                                             action="#{Doc_edo.crear_nuevo}"/>
