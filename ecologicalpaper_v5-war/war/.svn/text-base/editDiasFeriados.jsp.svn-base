...
<h:form>
	...
	<title><h:outputText styleClass="form"
		value="#{txt.editdiaferiado}" /></title>
	<h1></h1>
	<center>
	<h2><h:outputText styleClass="form" value="#{txt.editdiaferiado}" /></h2>
	</center>
	<p></p>
	...
	<h:form id="forma">
		<h:panelGrid columns="3" id="panelGrid1">
			...
			<t:inputCalendar disabled="true" id="fecha_creado"
				monthYearRowClass="yearMonthHeader" weekRowClass="weekHeader"
				popupButtonStyleClass="standard_bold"
				currentDayCellClass="currentDayCell"
				value="#{DiasFeriadosCliente.diasFeriadosBean.fechaonly}"
			...
			<h:commandButton styleClass="boton" id="btncancel" value="#{txt.btn_cancelar}"
				immediate="true" action="#{DiasFeriadosCliente.cancelar}" />

			<h:commandButton styleClass="boton" value="#{txt.btn_guardar}"
				action="#{DiasFeriadosCliente.save}" />
