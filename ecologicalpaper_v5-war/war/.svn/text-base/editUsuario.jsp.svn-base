		...
		<h:panelGroup>
			...
			<h:panelGrid columns="3" id="panelGrid1">
				...
				<h:inputTextarea id="desc2" cols="40" rows="3"
					value="#{ClienteUsuario.usuario.direccion}">
				...
				<h:outputText styleClass="form"
					value="#{txt.usuario_empresa} [#{ClienteUsuario.usuario.empresa.nombre}] "
					title="#{txt.usuario_empresa}" />
				<h:selectOneMenu id="selectOneMenuEmpresa"
					disabled="#{ClienteUsuario.swEditarUsuario}" immediate="true"
					binding="#{ClienteUsuario.selectEmpresa}"
				...
				<h:outputText styleClass="form"
					value="#{txt.flow_commentPrincipal} [#{ClienteUsuario.usuario.principal.nombre}] "
				...
				<h:outputText styleClass="form"
					value="#{txt.usuario_area} [#{ClienteUsuario.usuario.area.nombre}] "
				...
				<h:outputText styleClass="form"
					value="#{txt.usuario_cargo} [ #{ClienteUsuario.usuario.cargo.nombre} ]"
					title="#{txt.usuario_cargo}" />

				<h:selectOneMenu disabled="#{ClienteUsuario.swEditarUsuario}"
					id="selectOneMenuCargo" value="#{ClienteUsuario.usuario.cargo}"
				...
				<h:inputText id="login" disabled="#{ClienteUsuario.swEditarUsuario}"
					value="#{ClienteUsuario.usuario.login}"
				...
				<h:inputHidden id="passwordOculta"
					value="#{ClienteUsuario.passwordOculta}" />
			...
			<h:panelGrid columns="3" cellspacing="0" border="0" width="75%">
				...
				<h:commandButton styleClass="boton" rendered="#{!ClienteUsuario.swHistorico}"
					value="#{txt.usuario_guardar}"
					action="#{ClienteUsuario.saveEditUser}" />
