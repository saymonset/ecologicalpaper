            ...
            <h:form>
                <h:panelGrid columns="3" binding="#{backing_login.panelGrid1}"
                    ...
                    <h:commandButton  styleClass="boton" value="#{txt.btn_menu}" 
                                       action="#{CrearPais.cancelar}"/>
                    <h:commandButton styleClass="boton" rendered="#{CrearPais.swAdd}"
                                     value="#{txt.btn_crear}" 
                                     action="#{CrearPais.inic_crear}"/>
                    
                    
                </h:panelGrid>
                <h1><h:outputText styleClass="form"   value="#{txt.listarPaises}"/></h1>
                <a4j:region renderRegionOnly="true" id="stat3"> 
                    <h1> <h:outputText  value="#{txt.search_buscar}" />
                    </h1>
                    <h:panelGroup id="buscar">
                        
                        <h:inputText  id="searchtext" value="#{CrearPais.strBuscar}" immediate="true">
                    ...
                    <h:panelGroup id="body">
                        ...
                        >
                            <h:column>
                                ...
                                <h:panelGroup rendered="#{CrearPais.swMod}">
                                    <h:commandLink  id="Edit" 
                                                    action="#{CrearPais.edit}" 
                                                    actionListener="#{CrearPais.selection}">
