            ...
            <h:form>
                <h:panelGrid columns="3" binding="#{backing_login.panelGrid1}"
                    ...
                    <h:commandButton styleClass="boton"   value="#{txt.btn_menu}" 
                                       action="#{extensionFileCliente.cancelar}"/>
                   <% /*
                    <h:commandButton styleClass="boton" rendered="#{extensionFileCliente.swAdd}"
                                     value="#{txt.btn_crear}" 
                                     action="#{extensionFileCliente.inic_crear}"/>
                                     */ %>
                    
                    
                </h:panelGrid>
                <h1><h:outputText styleClass="form"   value="#{txt.tipodearchivo}"/></h1>
                <a4j:region renderRegionOnly="true" id="stat3"> 
                    <h1> <h:outputText  value="#{txt.search_buscar}" />
                    </h1>
                    <h:panelGroup id="buscar">
                        
                        <h:inputText  id="searchtext" value="#{extensionFileCliente.strBuscar}" immediate="true">
                            <a4j:support  event="onkeyup" reRender="data" />
                        </h:inputText>
                    ...
                    <h:panelGroup id="body">
                        ...
                        <t:dataTable id="data"
                                     ...
                                     var="car"
                                     value="#{extensionFileCliente.extensionFiles}"
                      ...
                      <% /*     <!--     <h:panelGroup rendered="#{extensionFileCliente.swMod}">
                                    <h:commandLink  id="Edit" 
                                                    action="#{extensionFileCliente.edit}" 
                                                    actionListener="#{extensionFileCliente.selection}">
                              ...
                              <h:column>
                                <f:facet name="header">
                                    ...
                                    <h:outputText styleClass="node" value="#{car.mimeType}"
                                                  title="#{car.mimeType}"/>
                            </h:column>
                            ...
                            <h:column>
                                ...
                                <h:panelGroup rendered="#{car.delete}">
                                    <h:commandLink  id="del" 
                                                    action="#{extensionFileCliente.delete}" 
                                                    actionListener="#{extensionFileCliente.selection}"
