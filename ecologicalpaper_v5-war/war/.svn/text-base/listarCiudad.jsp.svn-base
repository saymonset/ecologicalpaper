            ...
            <h:form>
                ...
                <h:panelGrid columns="4" binding="#{backing_login.panelGrid1}"
                    ...
                    <h:commandButton styleClass="boton"   value="#{txt.btn_menu}" 
                                       action="#{CrearCiudad.cancelar}"/>
                    <h:commandButton styleClass="boton" rendered="#{CrearCiudad.swAdd}"
                                     value="#{txt.btn_crear}" 
                                     action="#{CrearCiudad.inic_crear}"/>
                </h:panelGrid>
                    ...
                    <a4j:region renderRegionOnly="true" id="stat3">    
                        <h:panelGrid columns="3">
                            ...
                            <h:selectOneMenu 
                                id="selectPais"
                                immediate="true"
                                value="#{CrearCiudad.pais}" converter="ConverPais">
                                <a4j:support event="onchange"  
                                             reRender="selectEstado,data"
                                             action="#{CrearCiudad.colocarPaisSession}"
                                />
                            ...
                            <h:selectOneMenu 
                                id="selectEstado"
                                immediate="true"
                                value="#{CrearCiudad.estado}" converter="ConverEstado">
                                <a4j:support event="onchange"  
                                             reRender="data"
                                             action="#{CrearCiudad.colocarEstadoSession}"
                                />
                                <f:selectItems value="#{CrearCiudad.estados}" />
                            </h:selectOneMenu>
                            <h:message for="selectOneMenuPais" styleClass="form"/> 
                        </h:panelGrid>
                        ...
                        >
                            <h:column>
                                ...
                                <h:panelGroup rendered="#{CrearCiudad.swMod}">
                                    <h:commandLink  id="Edit" 
                                                    action="#{CrearCiudad.edit}" 
                                                    actionListener="#{CrearCiudad.selection}">
                            ...
                            <h:column>
                                ...
                                <h:outputText  styleClass="node" value="#{car.estado.nombre}" />
                            </h:column>
