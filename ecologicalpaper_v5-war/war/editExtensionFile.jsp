...
<f:view>
	...
	<h:form id="forma">
		<h:panelGrid columns="3" id="panelGrid1">
			...
			<h:inputText id="inputTextNombre" value="#{extensionFileCliente.extensionFile.extension}"
				immediate="false">
			...
			<h:inputText id="inputTextDescripcion"
				value="#{extensionFileCliente.extensionFile.mimeType}" immediate="false">
			...
			<h:commandButton styleClass="boton" value="#{txt.btn_guardar}"
				action="#{extensionFileCliente.saveObjeto}" />
