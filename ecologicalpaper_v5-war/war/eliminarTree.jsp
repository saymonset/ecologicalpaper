                ...
                <h:form id="forma">
                    <h:panelGrid columns="1" 
                        ...
                        <h:panelGrid columns="3" >
                            ...
                            <h:outputText styleClass="form" value=" #{txt.btn_erase}:#{Historico.toDelTree.nombre}"/>                
                            <f:verbatim></f:verbatim>
                        </h:panelGrid>
                    ...
                    <h:panelGroup id="body">
                        ...
                        >
                            <h:column>
                                ...
                                <h:outputText styleClass="form" value="#{car.usuario_anterior.nombre}
                            ...
                            <h:column>
                                ...
                                <h:outputText styleClass="form" value="#{car.usuario_accion.nombre}
