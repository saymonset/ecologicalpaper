            ...
            <h:form>
                <h:panelGrid columns="3" binding="#{backing_login.panelGrid1}"
                    ...
                    <h:commandButton styleClass="boton"  value="#{txt.btn_menu}" 
                                       action="#{svnUrlBaseCliente.cancelarLista}"/>
                    <h:commandButton styleClass="boton"
                        rendered="#{svnUrlBaseCliente.swAdd}"
                        value="#{txt.btn_crear}" 
                        action="#{svnUrlBaseCliente.crear_nuevo}"/>
                </h:panelGrid>
                ...
                <a4j:region renderRegionOnly="true" id="stat3"> 
                    ...
                    <h:panelGroup id="buscar">
                        <h:inputText  id="searchtext" value="#{svnUrlBaseCliente.strBuscar}" immediate="true">
                    ...
                    <h:panelGroup id="body">
                        ...
                        >
                            <h:column>
                                ...
                                <h:panelGroup rendered="#{svnUrlBaseCliente.swMod}">
                                    <h:commandLink  id="Edit" 
                                                    action="#{svnUrlBaseCliente.edit}" 
                                                    actionListener="#{svnUrlBaseCliente.selectId}">
                            ...
                            <h:column>
                                ...
                                <h:panelGroup rendered="#{car.delete}">
                                    <h:commandLink  id="del" 
                                                    action="#{svnUrlBaseCliente.delete}" 
                                                    actionListener="#{svnUrlBaseCliente.selectId}"
