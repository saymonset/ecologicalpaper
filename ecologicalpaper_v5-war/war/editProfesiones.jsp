...
<f:view>
	...
	<h1></h1>
	<center>
	<h2><h:outputText styleClass="form" value="#{txt.Profesion_p}" /></h2>
	</center>
	<p></p>
	...
	<h:form id="forma">
		<h:panelGrid columns="3" id="panelGrid1">
			...
			<h:inputText id="inputTextNombre"
				value="#{CrearProfesion.profesion.nombre}" immediate="false">
			...
			<h:inputTextarea cols="100" styleClass="form" rows="10"
					value="#{CrearProfesion.profesion.descripcion}"></h:inputTextarea>
					<% /*
			<t:inputHtml value="#{CrearProfesion.profesion.descripcion}"
			...
			<h:panelGroup>
				...
				<h:commandButton styleClass="boton" value="#{txt.btn_guardar}"
					action="#{CrearProfesion.saveObjeto}" />
			</h:panelGroup>
