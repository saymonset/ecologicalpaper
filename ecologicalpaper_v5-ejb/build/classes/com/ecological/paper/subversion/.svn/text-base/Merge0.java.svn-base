...
public class Merge0 {
     ...
     * without file system directories and files. In other words, we perform a low-level import creating 
     * directories and files entirely from code, not importing them from the file system.
     * 
    ...
    public static SVNCommitInfo createRepositoryTree(File reposRoot) throws SVNException {
        ...
        //sacamos el map con su clave un strring
